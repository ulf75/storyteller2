...
class e extends t {
    ...
    drawLoader(t, e, i, s) {
        ...
        t.beginPath(), (t.lineWidth = 10), t.arc(n.x, n.y, 20, this.loadingAngle, (3 * Math.PI) / 2 + this.loadingAngle), t.stroke(), t.closePath(), (this.loadingAngle += 0.07), this.loadingAngle >= 2 * Math.PI && (this.loadingAngle = 0);
    }
    load() {
        this.isLoad ||
            (this.image.onload = () => {
...
class s extends i {
    ...
    load() {
        for (const t of this.imagesHref) {
            const i = new e(this.render, t, "soft");
...
class n {
    ...
    static GetSegmentLength(t) {
        return n.GetDistanceBetweenTwoPoint(t[0], t[1]);
    }
    ...
    static LimitPointToCircle(t, e, i) {
        if (n.GetDistanceBetweenTwoPoint(t, i) <= e) return i;
        const s = t.x,
            h = t.y,
            r = i.x,
            a = i.y;
        let o = Math.sqrt((Math.pow(e, 2) * Math.pow(s - r, 2)) / (Math.pow(s - r, 2) + Math.pow(h - a, 2))) + s;
        i.x < 0 && (o *= -1);
        let g = ((o - s) * (h - a)) / (s - r) + h;
        return s - r + h === 0 && (g = e), { x: o, y: g };
    }
    static GetIntersectBetweenTwoSegment(t, e, i) {
        return n.PointInRect(t, n.GetIntersectBeetwenTwoLine(e, i));
    }
    static GetIntersectBeetwenTwoLine(t, e) {
        ...
        if (Math.abs(o - g) < 0.1) throw new Error("Segment included");
        return null;
    }
    static GetCordsFromTwoPoint(t, e) {
        ...
        for (let a = 1; a <= n; a += 1) h.push({ x: r(t.x, e.x, i, n, a), y: r(t.y, e.y, s, n, a) });
        return h;
    }
}
class h extends t {
    ...
    newTemporaryCopy() {
        return "hard" === this.nowDrawingDensity
            ...
            : (null === this.temporaryCopy &&
                  ((this.copiedElement = this.element.cloneNode(!0)), this.element.parentElement.appendChild(this.copiedElement), (this.temporaryCopy = new h(this.render, this.copiedElement, this.nowDrawingDensity))),
    ...
    drawSoft(t, e = "") {
        ...
        for (const t of this.state.area)
            if (null !== t) {
                ...
                (e = n.GetRotatedPoint(e, { x: 0, y: 0 }, this.state.angle)), (i += e.x + "px " + e.y + "px, ");
            }
        (i = i.slice(0, -2)), (i += ")");
        const s =
            e +
...
class a {
    ...
    getBottomClipArea() {
        ...
        return (
            ...
            null !== this.sideIntersectPoint
                ? n.GetDistanceBetweenTwoPoint(this.sideIntersectPoint, this.topIntersectPoint) >= 10 && t.push(this.sideIntersectPoint)
    ...
    getShadowAngle() {
        const t = n.GetAngleBetweenTwoLine(this.getSegmentToShadowLine(), [
            { x: 0, y: 0 },
    ...
    calculateIntersectPoint(t) {
        ...
        "top" === this.corner
            ? ((this.topIntersectPoint = n.GetIntersectBetweenTwoSegment(
                  e,
              ...
              (this.sideIntersectPoint = n.GetIntersectBetweenTwoSegment(
                  e,
              ...
              (this.bottomIntersectPoint = n.GetIntersectBetweenTwoSegment(
                  e,
    ...
    checkPositionAtCenterLine(t, e, i) {
        let s = t;
        const h = n.LimitPointToCircle(e, this.pageWidth, s);
        s !== h && ((s = h), this.updateAngleAndGeometry(s));
        ...
        if (("bottom" === this.corner && ((a = this.rect.topRight), (o = this.rect.bottomLeft)), a.x <= 0)) {
            const t = n.LimitPointToCircle(i, r, o);
...
class o {
    ...
    animateFlippingTo(t, e, i, s = !0) {
        const h = n.GetCordsFromTwoPoint(t, e),
            r = [];
        for (const t of h) r.push(() => this.do(t));
        const a = this.getAnimationDuration(h.length);
    ...
    isPointOnCorners(t) {
        const e = this.getBoundsRect(),
            ...
            s = Math.sqrt(Math.pow(pageWidth, 2) + Math.pow(e.height, 2)) / 20,
...
class g {
    ...
    calculateBoundsRect() {
        ...
        return (
            "stretch" === this.setting.size
                ...
                : e < 2 * h && this.app.getSettings().usePortrait && ((t = "portrait"), (a = i - h / 2 - h)),
            (this.boundsRect = { left: a, top: s - r / 2, width: 2 * h, height: r, pageWidth: h }),
            t
        );
    }
    ...
    convertRectToGlobal(t, e) {
        return (
            e || (e = this.direction), { topLeft: this.convertToGlobal(t.topLeft, e), topRight: this.convertToGlobal(t.topRight, e), bottomLeft: this.convertToGlobal(t.bottomLeft, e), bottomRight: this.convertToGlobal(t.bottomRight, e) }
        );
    }
}
class l extends g {
...
class d {
    ...
    checkTarget(t) {
        return !this.app.getSettings().clickEventForward || Array.from(t.classList).some(value => this.app.getSettings().clickEventClasses.includes(value));
...
class u extends g {
    ...
    drawInnerShadow() {
        const t = this.getRect(),
            ...
            h = this.convertToGlobal(this.shadow.pos),
        ...
        for (const t of a) {
            ...
            (e = n.GetRotatedPoint(e, { x: i, y: 100 }, r)), (o += e.x + "px " + e.y + "px, ");
        }
        (o = o.slice(0, -2)), (o += ")");
        const g = `\n            display: block;\n            z-index: ${(this.getSettings().startZIndex + 10).toString(10)};\n            width: ${e}px;\n            height: ${
            ...
            this.shadow.opacity
        }) 35%,\n                rgba(0, 0, 0, 0) 100%);\n            transform-origin: ${i}px 100px;\n            transform: translate3d(${h.x - i}px, ${
            h.y - 100
        }px, 0) rotate(${r}rad);\n            clip-path: ${o};\n            -webkit-clip-path: ${o};\n        `;
    ...
    drawOuterShadow() {
        const t = this.getRect(),
            ...
            h = 0 === this.getDirection() ? "to right" : "to left",
            r = [
                { x: 0, y: 0 },
                { x: t.pageWidth, y: 0 },
        ...
        for (const t of r)
            if (null !== t) {
                let e = 1 === this.getDirection() ? { x: -t.x + this.shadow.pos.x, y: t.y - this.shadow.pos.y } : { x: t.x - this.shadow.pos.x, y: t.y - this.shadow.pos.y };
                (e = n.GetRotatedPoint(e, { x: s, y: 100 }, i)), (a += e.x + "px " + e.y + "px, ");
            }
        (a = a.slice(0, -2)), (a += ")");
        ...
        this.outerShadow.style.cssText = o;
    }
    drawLeftPage() {
...
class x extends class {
    ...
    constructor(t, e) {
        super(), (this.isUserTouch = !1), (this.isUserMove = !1), (this.setting = null), (this.pages = null), (this.setting = new w().getSettings(e)), (this.block = t);
    }
    destroy() {
    ...
    loadFromImages(t) {
        this.ui = new c(this.block, this, this.setting);
        const e = this.ui.getCanvas();
        (this.render = new l(this, this.setting, e)),
            (this.flipController = new o(this.render, this)),
            (this.pages = new s(this, this.render, t)),
            this.pages.load(),
            this.render.start(),
    ...
    loadFromHTML(t) {
        (this.ui = new p(this.block, this, this.setting, t)),
            (this.render = new u(this, this.setting, this.ui.getDistElement())),
            (this.flipController = new o(this.render, this)),
    ...
    updateFromImages(t) {
        ...
        this.pages.destroy(), (this.pages = new s(this, this.render, t)), this.pages.load(), this.pages.show(e), this.trigger("update", this, { page: e, mode: this.render.getOrientation() });
    }
    updateFromHtml(t) {
        const e = this.pages.getCurrentPageIndex();
        this.pages.destroy(),
    ...
    userMove(t, e) {
        this.isUserTouch || e || !this.setting.showPageCorners ? this.isUserTouch && n.GetDistanceBetweenTwoPoint(this.mousePosition, t) > 5 && ((this.isUserMove = !0), this.flipController.fold(t)) : this.flipController.showCorner(t);
    }
    userStop(t, e = !1) {
        this.isUserTouch && ((this.isUserTouch = !1), e || (this.isUserMove ? this.flipController.stopMove() : this.flipController.flip(t)));
    }
}
export { x as PageFlip };
